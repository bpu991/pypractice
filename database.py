...
with app.app_context():
  ...
  problem1 = Problem(title='problem 1', instructions='Solve the problem', default_content='1 + 1', solution='2', tests='idk', difficulty=1)
  problem2 = Problem(title='problem 2', instructions='Solve the problem', default_content='1 + 2', solution='3', tests='idk', difficulty=1)
