...
import thirdAward from '../../../images/third-attempt.png'
...
export default function ThirdAttemptedAchievement() {
        ...
        <Container className={classes.root}>
            <Grid container elevation={3}>
                <Grid component={Paper} item style={{ padding: 10, display: 'flex', alignContent: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                    ...
                    <Typography variant="h5">You've made 10 attempts!</Typography>
                </Grid>
            </Grid>
        </Container>
    );
